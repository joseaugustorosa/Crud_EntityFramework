...
namespace Crud_EntityFramework.Controllers
{
    public class ComputadoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Marca,Processador,Placa_Mae,Memória,HD,NumeroPratrimonio,Data_compra")] Computadores computadores)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Marca,Processador,Placa_Mae,Memória,HD,NumeroPratrimonio,Data_compra")] Computadores computadores)
        {
